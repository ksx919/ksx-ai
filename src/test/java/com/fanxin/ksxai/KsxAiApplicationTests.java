package com.fanxin.ksxai;

import com.fanxin.ksxai.utils.TextCleanerUtils;
import com.fanxin.ksxai.utils.VectorDistanceUtils;
...
class KsxAiApplicationTests {
    ...
    public void testVectorStore(){
        Resource resource = new FileSystemResource("蚁群算法.pdf");
        ...
        //4、搜索
        List<Document> docs = vectorStore.similaritySearch("蚁群算法");
        if (docs == null){
